          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMen">
                ...
                <li><a class="dropdown-item" href="shose.html">shose & Outfit</a></li>
                <li><a class="dropdown-item" href="shirt.html">Pants & shirts</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownWomen">
                ...
                <li><a class="dropdown-item" href="/women-dress.html">Dresses</a></li>
                <li><a class="dropdown-item" href="women-skirt.html">Skirts</a></li>
...
<div class="row">
  <div class="col-lg-3 col-md-6">
    ...
    <ul class="footer-links">
      <li><a href="women-dress.html">Dresses</a></li>
      <li><a href="women-pants.html">pants</a></li>
      <li><a href="women-skirt.html">skirt</a></li>
    </ul>
  </div>
  <div class="col-lg-3 col-md-6">
    <h5>Men</h5>
  ...
  <div class="col-lg-3 col-md-6">
    <h5>Kids</h5>
    <ul class="footer-links">
    <li><a href="kids.html">Boys</a></li>
    <li><a href="kids.html">Girls</a></li>
