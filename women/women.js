      ...
      <div class="container ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="All prodct/All-product.html">All Products</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMen">
                <li><a class="dropdown-item" href="men product/men-all.html">All </a></li>
                <li><a class="dropdown-item" href="men product/shose.html">shose & Outfit</a></li>
                <li><a class="dropdown-item" href="men product/shirt.html">Pants & shirts</a></li>
                <li><a class="dropdown-item" href="men product/hoodies.html">Hoodies</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownWomen">
                <li><a class="dropdown-item" href="women product/women-all.html">All</a></li>
                <li><a class="dropdown-item" href="women product/women-dress.html">Dresses</a></li>
                <li><a class="dropdown-item" href="women product/women-skirt.html">Skirts</a></li>
                <li><a class="dropdown-item" href="women product/women-pants.html">Pants</a></li>
              </ul>
            </li>
            <li class="nav-item">
...
<div class="row">
  <div class="col-lg-3 col-md-6">
    ...
    <ul class="footer-links">
      <li><a href="women product/women-dress.html">Dresses</a></li>
      <li><a href="women product/women-pants.html">pants</a></li>
      <li><a href="women product/women-skirt.html">skirt</a></li>
    </ul>
  </div>
  <div class="col-lg-3 col-md-6">
    <h5>Men</h5>
    <ul class="footer-links">
    <li><a href="men product/shirt.html">shirt</a></li>
    <li><a href="men product/shose.html">Shoes</a></li>
    <li><a href="men product/hoodies.html">hoodies</a></li>
    </ul>
  </div>
  <div class="col-lg-3 col-md-6">
    <h5>Kids</h5>
